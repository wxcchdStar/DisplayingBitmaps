...
public class ImageCache {
     ...
     * @param cacheParams 后添加的参数，原来是没有的。添加的原因是想图片在缓存到本地时可以不比统一压缩格式及压缩质量。
     */
    public void addBitmapToCache(String data, BitmapDrawable value, ImageCacheParams cacheParams) {
